...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/KANHAxBOSS/LEGEND-KANHA.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/KANHA_TECH_SUPPORT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/KANHA_TECH")
